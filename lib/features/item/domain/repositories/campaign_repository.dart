...
class CampaignRepository implements CampaignRepositoryInterface {
  ...
  Future<List<BasicCampaignModel>?> _getBasicCampaignList(DataSourceEnum source) async {
    ...
    String cacheId = '${AppConstants.basicCampaignUri}-banner&moduleId=${Get.find<SplashController>().module!.id}';
  ...
  Future<List<Item>?> _getItemCampaignList(DataSourceEnum source) async {
    ...
    String cacheId = '${AppConstants.basicCampaignUri}&moduleId=${Get.find<SplashController>().module!.id}';
