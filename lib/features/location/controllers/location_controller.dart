...
// function mobile 
  ...
  // function web 
//   Future<void> syncZoneData() async {
//   if (_zoneSynced) return; // 🔥 يمنع التكرار
...
//   if (response.zoneIds == null || response.zoneIds.isEmpty) {
//     address.zoneId = AppConstants.defaultZoneId;
//     address.zoneIds = [AppConstants.defaultZoneId];

//     await AddressHelper.saveUserAddressInSharedPref(address);

//     _zoneSynced = true; // 🔥 مهم جدًا
//     update();
//     return;
//   }

//   address.zoneId = response.zoneIds.first;
//   address.zoneIds = List<int>.from(response.zoneIds);
