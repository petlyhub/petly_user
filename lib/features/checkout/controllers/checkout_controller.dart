...
// add code payment method
//   PaymentMethod? _selectedMethod;
//   PaymentMethod? get selectedMethod => _selectedMethod;

//   void setPaymentMethodAll(PaymentMethod method) {
...
//    String get paymentMethodValueAll {
...
//       return;
//     }
// final orderService = Get.find<OrderServiceInterface>();
...
//       Get.snackbar(
//         "Success",
//         "Updated to: $paymentMethodValue",
//         snackPosition: SnackPosition.BOTTOM,
//       );

//       /// Paymob أو Tamara
//       if (paymentMethodValue == "paymob" ||
//           paymentMethodValue == "tamara") {
//         final String? paymentUrl = response.body["payment_url"];
...
//       Get.snackbar(
//         "Error",
//         response.statusText ?? "Payment update failed",
//         snackPosition: SnackPosition.BOTTOM,
//       );
//     }
//   }
  ...
  Future<String> placeOrder(
    ...
    if (response.statusCode == 200) {
      ...
      if (kDebugMode) {
        print('PLACE_ORDER SUCCESS -> orderID: $orderID, message: $message,');
      }
  ...
  void callback(
    ...
    if (isSuccess) {
      if (kDebugMode) {
        print(
            'CALLBACK invoked -> orderID: $orderID, paymentMethodIndex: $paymentMethodIndex, digitalPaymentName: $digitalPaymentName');
      }
      if (fromCart) {
