...
class _PaymentMethodBottomSheetState extends State<PaymentMethodBottomSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    print('DIGITAL ACTIVE => ${widget.isDigitalPaymentActive}');
    print('NOT HIDE => $notHideDigital');

    print(
      'PAYMENT METHODS => ${Get.find<SplashController>().configModel!.activePaymentMethodList!.map((e) => e.getWay).toList()}',
    );
                ...
                child: GetBuilder<CheckoutController>(
                  ...
                  return Column(
                    ...
                    children: [
                                  ...
                                  child: PaymentButtonNew(
                                    ...
                                    onTap: () {
                                      if (canSelectWallet) {
                                        ...
                                        print(
                                            "Selected Index: ${checkoutController.paymentMethodIndex}");
                                        print(
                                            "Selected Method: ${checkoutController.paymentMethodValue}");
                      ...
                      //                     : 0),
                      //             child: PaymentButtonNew(
                      //               icon: Images.paymentPaymob,
                      //               title: 'pay via Paymob'.tr,
                      //               isSelected:
                      //                   checkoutController.paymentMethodIndex ==
                      //                       2,
                      //               onTap: () {
                      ...
                      Row(
                        ...
                        //                   : 0),
                        //           child: PaymentButtonNew(
                        //             icon: Images.paymentTamara,
                        //             title: 'pay via Tamara'.tr,
                        //             isSelected:
                        //                 checkoutController.paymentMethodIndex ==
                        //                     3,
                        //             onTap: () {
                        //               checkoutController
                        //                   .changeDigitalPaymentName('TAMARA');
                        //               print("TAMARA CLICKED");
                        //               checkoutController.setPaymentMethod(3);
                      ...
                      widget.isDigitalPaymentActive && notHideDigital
                          ? ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                print(
                                    'DIGITAL NAME => ${checkoutController.digitalPaymentName}');
                                print(
                                    "UI METHOD => ${checkoutController.paymentMethodIndex}");
