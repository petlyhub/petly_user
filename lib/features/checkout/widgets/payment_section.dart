          ...
          child: Row(children: [
            ...
            checkoutController.paymentMethodIndex != -1 ? Image.asset(
              checkoutController.paymentMethodIndex == 0 ? Images.cash
                  ...
                  : checkoutController.paymentMethodIndex == 4 ? Images.offlinePayment // أيقونة تمارا المضافة من قبلك
                  : Images.cash,
              width: 20, 
              height: 20,
              color: Theme.of(context).textTheme.bodyMedium!.color,
              ...
              child: Row(children: [
                Text(
                  checkoutController.paymentMethodIndex == 0 ? 'cash_on_delivery'.tr
                      ...
                      : checkoutController.paymentMethodIndex == 4 ? 'tamara'.tr // نص تمارا مع الترجمة
