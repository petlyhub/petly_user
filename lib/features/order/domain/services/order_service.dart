...
class OrderService implements OrderServiceInterface {
  ...
  void paymentRedirect(
    ...
    final bool noAddFundUrl = addFundUrl == null || addFundUrl.isEmpty;
    final bool noSubscriptionUrl = subscriptionUrl == null || subscriptionUrl.isEmpty;
    final bool forOrder = noAddFundUrl && noSubscriptionUrl;
    final bool forSubscription = (subscriptionUrl != null && subscriptionUrl.isNotEmpty) && noAddFundUrl;
...
@override
  Future<Response> updatePaymentMethod({
    ...
    return await orderRepositoryInterface.updatePaymentMethod(
      orderId: orderId,
