...
class OrderController extends GetxController implements GetxService {
  ...
  // Future<void> placePayment(String orderId, String guestId) async {

  //   final response = await orderServiceInterface.updatePaymentMethod(
  //     orderId: orderId,
  ...
  //       openPaymentGateway(orderId);
  //     } else if (paymentMethodValue == "wallet") {

  //       Get.snackbar("Success", "Paid via wallet");
  //     } else {

  //       Get.snackbar("Success", "COD selected");
  //     }
  //   } else {
  ...
  // void openPaymentGateway(String orderId) {
  //   // WebView / iframe redirect
  // }
