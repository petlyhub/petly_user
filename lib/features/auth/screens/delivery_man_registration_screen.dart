...
import 'package:sixam_mart/common/widgets/text_upload_note_widget.dart';
import 'package:sixam_mart/common/widgets/user_type_drop_down.dart';
import 'package:sixam_mart/common/widgets/vehical_image_widget/vehical_image_item.dart';
                                        ...
                                        child: Form(
                                          ...
                                          child: Column(children: [
                                            ...
                                            Align(
                                                ...
                                                child: TextUploadNoteWidget(
                                                    title: 'upload_note'.tr)),
                                            const SizedBox(
                                              height: Dimensions
                                                  .paddingSizeExtraLarge,
                                            ),
                                            ListView.builder(
                                              ...
                                              physics:
                                                  const NeverScrollableScrollPhysics(),
                                              itemCount: deliverymanRegistrationController
                                                      .pickedLicenses.isEmpty
                                                  ? deliverymanRegistrationController
                                                          .pickedLicenses
                                                          .length +
                                                      1
                                                  : deliverymanRegistrationController
                                                      .pickedLicenses.length,
                                              itemBuilder: (context, index) {
                                                XFile? file = index ==
                                                        deliverymanRegistrationController
                                                            .pickedLicenses
                                            ...
                                            ListView.builder(
                                              ...
                                              physics:
                                                  const NeverScrollableScrollPhysics(),
                                              itemCount: deliverymanRegistrationController.pickedVehicleImagelist.length < 3
                                                  ? deliverymanRegistrationController
                                                          .pickedVehicleImagelist
                                                          .length +
                                                      1
                                                  : deliverymanRegistrationController
                                                      .pickedVehicleImagelist
                                            ...
                                            ListView.builder(
                                              ...
                                              physics:
                                                  const NeverScrollableScrollPhysics(),
                                              itemCount: deliverymanRegistrationController.pickedCardDriverlist.isEmpty
                                                  ? deliverymanRegistrationController
                                                          .pickedCardDriverlist
                                                          .length +
                                                      1
                                                  : deliverymanRegistrationController
                                                      .pickedCardDriverlist
...
//     deliverymanRegistrationController.setUserType(value, true);
//   },
//   items: const [
//     DropdownItem(value: 'saudi', child: Text('سعودي')),
//     DropdownItem(value: 'resident', child: Text('مقيم')),
//   ],
//   child: Text(
//     deliverymanRegistrationController.userType.isEmpty
//         ? 'اختر نوع المستخدم'
//         : (deliverymanRegistrationController.isSaudi
//             ? 'سعودي'
//             : 'مقيم'),
//   ),
// ),
                      ...
                      Container(
                        ...
                        child: Column(children: [
                          ...
                          Row(children: [
                            ...
                            // CustomDropdown<String>(
                            //   onChange: (value, index) {
                            //     deliverymanRegistrationController.setUserType(
                            //         value, true);
                            //   },
                            //   items: deliverymanRegistrationController
                            //       .userTypeList
                            //       .map((type) {
                            //     return DropdownItem<String>(
                            //       value: type,
                            //       child:
                            //           Text(type == 'saudi' ? 'سعودي' : 'مقيم'),
                            //     );
                            //   }).toList(),
                            //   child: Text(
                            //       deliverymanRegistrationController.userType ==
                            //               'saudi'
                            //           ? 'سعودي'
                            //           : 'مقيم'),
                            // ),
      ...
      if (_formKeyStep2!.currentState!.validate()) {
        if (identityNumber.isEmpty) {
          ...
          deliverymanRegiController.registerDeliveryMan(DeliveryManBody(
            ...
            email: email,
            userType: deliverymanRegiController.selectedType.name,
